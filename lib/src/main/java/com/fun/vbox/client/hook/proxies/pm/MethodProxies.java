...
class MethodProxies {
    ...
    static class GetUidForSharedUser extends MethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            ...
            return VCore.get().getUidForSharedUser(sharedUserName);
        }
    ...
    static final class GetPackageInfo extends MethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            String pkg = (String) args[0];
            if (SpecialComponentList.FB_PACKAGE_NAME.equals(pkg) && !SpecialComponentList.isFbEnable(VClient.get().getCurrentPackage())) {
                return null;
            }
    ...
    static class GetPackagesForUid extends MethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            ...
            if (pkgs == null) {
                return VCore.get().getUnHookPackageManager().getPackagesForUid(uid);
            }
            return pkgs;
        }
    ...
    static class checkUidSignatures extends MethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            ...
            String[] pkgs1 = VCore.getPM().getPackagesForUid(uid1);
            String[] pkgs2 = VCore.getPM().getPackagesForUid(uid2);
    ...
    static class DeletePackage extends MethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            String pkgName = (String) args[0];
            try {
                VCore.get().uninstallPackage(pkgName);
    ...
    static class GetInstalledApplications extends MethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            ...
            while (it.hasNext()) {
                ...
                if (VCore.get().isAppInstalled(info.packageName) || !isVisiblePackage(info.packageName)) {
                    it.remove();
                }
                ComponentFixer.fixOutsideApplicationInfo(info);
            }
