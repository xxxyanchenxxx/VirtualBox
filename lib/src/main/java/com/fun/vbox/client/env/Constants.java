...
import com.zb.vv.client.stub.ShortcutHandleActivity;
...
public class Constants {
	...
	public static String APACHE_LEGACY = null;
	public static final String APACHE_LEGACY_P = "/system/framework/org.apache.http.legacy.boot.jar";
	public static final String APACHE_LEGACY_Q = "/system/framework/org.apache.http.legacy.jar";

	static {
		if (BuildCompat.isQ()) {
			APACHE_LEGACY = APACHE_LEGACY_Q;
		} else {
			APACHE_LEGACY = APACHE_LEGACY_P;
		}
	}
}
