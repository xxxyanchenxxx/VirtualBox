...
import com.fun.vbox.helper.utils.EncodeUtils;
...
public class VEnvironment {
    ...
    private static final File n = VCore.get().getContext().getExternalFilesDir("");
    ...
    public static File n(String str) {
        return ensureCreated(new File(new File(n, "ExternalSdcard"), str));
    }

    public static File m() {
        return ensureCreated(new File(n, "VirtualSdcard"));
    }
}