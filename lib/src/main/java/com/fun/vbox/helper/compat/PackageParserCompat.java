...
import mirror.vbox.content.pm.PackageParserJellyBean;
import mirror.vbox.content.pm.PackageParserJellyBean17;
import mirror.vbox.content.pm.PackageParserLollipop;
import mirror.vbox.content.pm.PackageParserLollipop22;
import mirror.vbox.content.pm.PackageParserMarshmallow;
import mirror.vbox.content.pm.PackageParserNougat;
import mirror.vbox.content.pm.PackageParserPie;
import mirror.vbox.content.pm.PackageUserState;
...
public class PackageParserCompat {
    ...
    public static final int[] GIDS = VCore.get().getGids();
    ...
    public static PackageParser createParser(File packageFile) {
        if (API_LEVEL >= M) {
            ...
            return mirror.vbox.content.pm.PackageParser.ctor.newInstance(packageFile.getAbsolutePath());
        }
    }
    ...
    public static Package parsePackage(PackageParser parser, File packageFile, int flags) throws Throwable {
        if (API_LEVEL >= M) {
            ...
            return mirror.vbox.content.pm.PackageParser.parsePackage.callWithException(parser, packageFile, null,
                    new DisplayMetrics(), flags);
        }
    }
    ...
    public static ServiceInfo generateServiceInfo(Service service, int flags) {
        if (API_LEVEL >= M) {
            ...
            return mirror.vbox.content.pm.PackageParser.generateServiceInfo.call(service, flags);
        }
    }
    ...
    public static ApplicationInfo generateApplicationInfo(Package p, int flags) {
        if (API_LEVEL >= M) {
            ...
            return mirror.vbox.content.pm.PackageParser.generateApplicationInfo.call(p, flags);
        }
    }
    ...
    public static ActivityInfo generateActivityInfo(Activity activity, int flags) {
        if (API_LEVEL >= M) {
            ...
            return mirror.vbox.content.pm.PackageParser.generateActivityInfo.call(activity, flags);
        }
    }
    ...
    public static ProviderInfo generateProviderInfo(Provider provider, int flags) {
        if (API_LEVEL >= M) {
            ...
            return mirror.vbox.content.pm.PackageParser.generateProviderInfo.call(provider, flags);
        }
    }
    ...
    public static PackageInfo generatePackageInfo(Package p, int flags, long firstInstallTime, long lastUpdateTime) {
        if (API_LEVEL >= M) {
            ...
            return mirror.vbox.content.pm.PackageParser.generatePackageInfo.call(p, GIDS, flags, firstInstallTime,
                    lastUpdateTime);
        }
    }
    ...
    public static void collectCertificates(PackageParser parser, Package p, int flags) throws Throwable {
        if (BuildCompat.isPie()) {
            ...
            mirror.vbox.content.pm.PackageParser.collectCertificates.call(parser, p, flags);
        }
    }
}
