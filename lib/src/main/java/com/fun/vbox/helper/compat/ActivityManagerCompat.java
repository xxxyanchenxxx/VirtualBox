...
import mirror.vbox.app.ActivityManager;
import mirror.vbox.app.ActivityManagerNative;
import mirror.vbox.app.IActivityManager;
import mirror.vbox.app.IActivityManagerICS;
import mirror.vbox.app.IActivityManagerL;
import mirror.vbox.app.IActivityManagerN;
...
public class ActivityManagerCompat {
    ...
    public static void setActivityOrientation(Activity activity, int orientation) {
        try {
            ...
            while (parent != null) {
                parent =  mirror.vbox.app.Activity.mParent.get(parent);
            }
            IBinder token = mirror.vbox.app.Activity.mToken.get(parent);
            try {
