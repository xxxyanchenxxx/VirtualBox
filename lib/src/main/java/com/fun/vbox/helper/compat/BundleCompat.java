...
import mirror.vbox.os.BaseBundle;
import mirror.vbox.os.BundleICS;
...
public class BundleCompat {
    public static IBinder getBinder(Bundle bundle, String key) {
        if (Build.VERSION.SDK_INT >= 18) {
            ...
            return mirror.vbox.os.Bundle.getIBinder.call(bundle, key);
        }
    }
    ...
    public static void putBinder(Bundle bundle, String key, IBinder value) {
        if (Build.VERSION.SDK_INT >= 18) {
            ...
            mirror.vbox.os.Bundle.putIBinder.call(bundle, key, value);
        }
    }
