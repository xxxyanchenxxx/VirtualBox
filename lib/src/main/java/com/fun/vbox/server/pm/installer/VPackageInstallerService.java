...
import static com.fun.vbox.server.pm.installer.PackageHelper.installStatusToPublicStatus;
import static com.fun.vbox.server.pm.installer.PackageHelper.installStatusToString;
