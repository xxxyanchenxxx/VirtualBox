...
public class WindowPreviewActivity extends Activity {
    ...
    public static void previewActivity(int userId, ActivityInfo info) {
        ...
        windowBackgroundIntent.putExtra("_VBOX_|user_id", userId);
        windowBackgroundIntent.putExtra("_VBOX_|activity_info", info);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityInfo info = intent.getParcelableExtra("_VBOX_|activity_info");
        int userId = intent.getIntExtra("_VBOX_|user_id", -1);
